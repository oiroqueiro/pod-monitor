...
echo "🏗️  Building hardened Promtail image..."
podman build -t "${REGISTRY}/monitor-promtail:latest" -f "$PROJECT_DIR/build/promtail.Containerfile" "$PROJECT_DIR"
...
podman push "${REGISTRY}/monitor-promtail:latest"
