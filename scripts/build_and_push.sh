...
echo "🏗️  Building hardened Prometheus image..."
podman build -t "${REGISTRY}/monitor-prometheus:latest" -f "$PROJECT_DIR/build/prometheus.Containerfile" "$PROJECT_DIR"
...
podman push "${REGISTRY}/monitor-prometheus:latest"
